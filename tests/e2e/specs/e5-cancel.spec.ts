...
// Note: the existing unit test at src/sync/sync.test.ts used to accept either
// outcome ("should either cancel or complete (race condition)") — that test has
// been updated to require explicit cancellation.
